...
namespace WebScraperAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //Binding section to the object
            var swaggerOption = new WebScraperAPI.Options.SwaggerOptions();
            Configuration.GetSection(nameof(WebScraperAPI.Options.SwaggerOptions)).Bind(swaggerOption);
